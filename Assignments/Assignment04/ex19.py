...
print("OR, we can use variables from our script:") # Here, we pass the numbers through variables:
amount_of_cheese = 10
amount_of_crackers = 50

cheese_and_crackers(amount_of_cheese, amount_of_crackers) # objects are variables
